...
var _libEasyDayJs = require('../../lib/EasyDay.js');

var _libEasyDayJs2 = _interopRequireDefault(_libEasyDayJs);

var EasyDayCmpnt = _react2['default'].createElement(_libEasyDayJs2['default'], {
    days: 64,
    onChange: function onChange(bitmask) {
        console.log('bitmask: ' + bitmask);
    }
});

_react2['default'].render(EasyDayCmpnt, document.getElementById('easy-day'));
},{"../../lib/EasyDay.js":2,"react":159}],2:[function(require,module,exports){
...
var EasyDay = (function (_React$Component) {
    ...
    _createClass(EasyDay, null, [{
        ...
        key: 'propTypes',
        value: {
            days: _react2['default'].PropTypes.oneOfType([_react2['default'].PropTypes.number, _react2['default'].PropTypes.array, _react2['default'].PropTypes.object]),
            useDarkTheme: _react2['default'].PropTypes.bool,
            showLetters: _react2['default'].PropTypes.bool,
            showLongNames: _react2['default'].PropTypes.bool,
            showShortNames: _react2['default'].PropTypes.bool,
            maxSelectedDays: _react2['default'].PropTypes.number,

            //Min isn't really supported. The initial value of props.days needs to be checked.
            minSelectedDays: _react2['default'].PropTypes.number,
    ...
    _createClass(EasyDay, [{
        ...
        value: function render() {
            ...
            var classes = (0, _classnames2['default'])('easy-day', {
...
},{"classnames":3,"react":159}],3:[function(require,module,exports){
/*!
